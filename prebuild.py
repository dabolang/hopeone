...
[docs]def copydocs(files, tempsuffix):
    """
...
[docs]def listfiles(docroot, suffix, ignore):
    """
...
[docs]def writefile(outfile, data):
    """
    Write data to file.
